...
class SelectionController extends Controller
{
    ...
    {
        //ID свойств у муфт
        $props_id = [97, 85, 86, 109, 111, 112, 113, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 1410, 114]; //local
        // $props_id = [11526, 11527, 11529, 11546, 11547, 11548, 11596, 11597, 11598, 11599, 11600, 11601, 11602, 11603, 11604, 11605, 11607, 11608, 11609]; //prod
